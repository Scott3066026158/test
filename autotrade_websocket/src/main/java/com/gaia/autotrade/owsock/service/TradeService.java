...
public class TradeService extends BaseService {
	...
	// 买开，限价
	public int OpenBuy(String tradePair, String traderID, String feeTarget, String flag, int orderType, double price,
			double volume) {
		try {
			Binary binary = new Binary();
	...
	// 卖开，限价
	public int OpenSell(String tradePair, String traderID, String feeTarget, String flag, int orderType, double price,
			double volume) {
		try {
			Binary binary = new Binary();
			binary.WriteString(flag);
