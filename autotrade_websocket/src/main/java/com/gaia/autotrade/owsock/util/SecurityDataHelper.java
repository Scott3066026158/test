...
public class SecurityDataHelper
{
    ...
    public static void BindHistoryDatas(ChartA chart, CTable dataSource, java.util.ArrayList<CIndicator> indicators, int[] fields, java.util.ArrayList<CoinData> historyDatas, boolean  showMinuteLine)
    {
        ...
        if (showMinuteLine)
        {
            ...
            CMathLib.佛祖(date, tempRef_tm_year, tempRef_tm_mon, tempRef_tm_mday, tempRef_tm_hour, tempRef_tm_min, tempRef_tm_sec, tempRef_tm_msec);
...
//                }
     ...
     * @param index
     */
    public static void InsertLatestData( CTable dataSource, ArrayList<CIndicator> indicators, int[] fields, float preClose, int index)
    {
