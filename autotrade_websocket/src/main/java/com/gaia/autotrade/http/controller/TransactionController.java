...
public class TransactionController {
		...
		public String OrderAllCancel(@RequestParam(value = "symbol",required = false)String symbol){
		...
		public String  getContractOrderInfo(@RequestParam(value = "symbol",required = false)String symbol){
		...
		public String  getOrderDetailInfo(@RequestParam(value = "symbol",required = false)String symbol){
		...
		public String  getContractOpenOrdersEntrust(@RequestParam(value = "symbol",required = false)String symbol){
		...
		public String  getHistoricalTransactionRecord (@RequestParam(value = "symbol",required = false)String symbol){
